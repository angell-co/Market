...
class VendorSettings extends Component
{
    ...
    const CONFIG_VENDOR_SETTINGS_KEY = 'market.settings.vendors';
     ...
     * @throws \Throwable
     */
    public function handleChangedVendorSettings(ConfigEvent $event): void
    {
     ...
     */
    public function handleDeletedVendorSettings(ConfigEvent $event): void
    {
